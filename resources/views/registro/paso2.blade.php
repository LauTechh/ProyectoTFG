...
<head>
    ...
    <style>
        ...
        .avatar-selector { max-width: 800px; margin: 0 auto; background: white; padding: 30px; border-radius: 15px; box-shadow: 0 4px 15px rgba(0,0,0,0.1); }
        
        /* Escondemos el circulito de radio feo */
        .avatar-selector input[type="radio"] { display: none; }
        
        /* Estilo de la etiqueta que envuelve la imagen */
        .avatar-selector label { display: inline-block; margin: 10px; cursor: pointer; }
        ...
        .avatar-selector img {
            ...
            border-radius: 15px;
            width: 100px; /* Tamaño fijo pequeño para practicidad */
            height: 100px; /* Mantenemos proporción cuadrada */
            object-fit: contain; /* Asegura que se vea todo el PNG */
            background-color: #f9f9f9; /* Fondo muy suave para ver el PNG */
            padding: 5px;
        }
        
        /* Estilo al pasar el ratón */
        .avatar-selector label:hover img { background-color: #e0e0e0; transform: scale(1.1); }
        ...
        /* Títulos de sección */
        h3 { border-bottom: 2px solid #eee; padding-bottom: 10px; margin-top: 30px; color: #333; }
        
        /* Botón final */
        .btn-finalizar {
            background-color: #4CAF50; color: white; border: none; padding: 15px 30px;
            font-size: 18px; border-radius: 25px; cursor: pointer; transition: background 0.2s;
            margin-top: 40px;
        }
        .btn-finalizar:hover { background-color: #45a049; }
    </style>
</head>
<body>
    ...
    <form action="/registro/finalizar" method="POST" class="avatar-selector">
        ...
        <button type="submit" class="btn-finalizar">¡Completar Registro!</button>
    </form>
